      ...
      >
        ...
        <el-table-column prop="year" label="年份" width="130">
          <template slot-scope="scope">
            <!-- <el-input
              ...
              v-model="singleTableParams.year"
            >
            </el-input> -->
        ...
        <el-table-column prop="month" label="月份" width="100">
          <template slot-scope="scope">
            <!-- <el-input
              v-if="scope.row.isEdit == true"
              v-model="singleTableParams.month"
            >
            </el-input> -->
        ...
        <el-table-column prop="equipmentNum" label="设备编号">
          <template slot-scope="scope">
            <el-input
              v-if="scope.row.isEdit == true"
              v-model="singleTableParams.equipmentNum"
            >
            </el-input>
            <span v-else>
...
export default {
  ...
  methods: {
    ...
    handleSuccess({ results, header }) {
      ...
      // 1、header必须一样
      // 2、不能为空
      let checkArr = ['年份', '月份', '研发项目序号', '种类', '编号', '摘要', '设备编号', '研发设备名称', '费用类型', '月折旧额 （元）', '工作工时', '研发工时']
